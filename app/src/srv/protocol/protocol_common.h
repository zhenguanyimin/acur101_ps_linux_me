...
#include "../../app/Tracking/src/utilities/embed_api.h"
...
typedef enum protocol_info_type {
	...
	PIT_DOT_COHE_OBJ  	= 0x1002, // object(s) dotCohesion

	/* parameter information */
	PIT_BEAM_SCHEDULING = 0x2000, // beam scheduling
	PIT_CFG_PARAM 		= 0x2001, // debugging / configuration parameter information
	AMP_CODE_PARAM 		= 0x2002, // Amp_Code
	PHASE_DATA_PARAM 	= 0x2003, // INIT_PHASE_DATA
	AMP_DATA_PARAM 		= 0x2004, // INIT_AMP_DATA
	...
	PIT_RDMAP_DATA		= 0x4010, // RDMAP data
	PIT_SRC_ADC_DATA	= 0x4011, // SRC ADC data
	PIT_IQ_ADC_DATA		= 0x4012, // IQ ADC data
